...
<div align="center">
  <table>
    <tr>
      <td><img src="mobile.png" height="380" alt="Mobile Screenshot"></td>
      <td><img src="pc.png" height="380" alt="Linux Screenshot"></td>
    </tr>
  </table>
</div>
...
*   Профилирование GeoIP & ISP: Автоматическая корреляция сетевых узлов с географическим местоположением и данными автономных систем (ASN).
